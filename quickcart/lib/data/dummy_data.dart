...
class DummyData {
  ...
  static const categories = [
    CategoryItem(name: 'Veggies', icon: Icons.eco, color: Color(0xFFB8F0B0)),
    CategoryItem(name: 'Fruits', icon: Icons.apple, color: Color(0xFFFF7777)),
    CategoryItem(name: 'Dairy', icon: Icons.local_drink, color: Colors.white),
    CategoryItem(name: 'Meat', icon: Icons.set_meal, color: Color(0xFFD50000)),
    CategoryItem(name: 'Bakery', icon: Icons.bakery_dining, color: Color(0xFFFFF1A3)),
    CategoryItem(name: 'Snacks', icon: Icons.cookie, color: Color(0xFF4D2434)),
  ];
  ...
  static const products = [
    Product(
      ...
      price: 2.99,
      discount: 33,
      description: 'Crisp, sweet red apples picked fresh for healthy snacks, baking, and lunch boxes.',
    ),
    Product(
      id: 'p2',
      name: 'Green Apples',
    ...
    Product(
      ...
      price: 5.99,
      discount: 10,
      description: 'Imported seedless grapes with juicy sweetness in every handful.',
    ),
    Product(
      id: 'p4',
      name: 'Fresh Broccoli',
      ...
      price: 1.49,
      discount: 25,
      description: 'Green broccoli florets packed with flavor for stir fries, soups, and roasting.',
    ),
    Product(
      id: 'p5',
      name: 'Whole Toast',
      ...
      price: 3.49,
      discount: 31,
      description: 'Soft whole-grain toast slices baked fresh for breakfast and sandwiches.',
    ),
    Product(
      id: 'p6',
      name: 'Fresh Milk',
      ...
      price: 2.99,
      discount: 0,
      description: 'Creamy farm-raised milk for cereal, coffee, smoothies, and cooking.',
    ),
    Product(
      id: 'p7',
      name: 'Chicken Breast',
